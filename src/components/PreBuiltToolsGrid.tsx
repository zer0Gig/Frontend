...
const FALLBACK_SKILLS: PlatformSkill[] = [
  ...
  { id: "telegram_notify", name: "Telegram Notify",  description: "Agent sends milestone cards and approve buttons to your Telegram",     category: "communication", icon: "telegram_notify", is_active: true, is_verified: true,  tool_type: "builtin", config_schema: { properties: { chatId: { type: "string", title: "Telegram Chat ID", description: "Connect your Telegram below to get your Chat ID automatically" } } }, metadata: {} },
